...
def ShowUsage():
    ...
    print(r"%-44s\t\tpython ptool.py -x partition.xml -s c:\windows" % ("Search path to find partition.xml"))
...
def prettify(elem):
    ...
    """
    # Python 2's ElementTree serialized attributes in sorted order. Python 3
    # preserves insertion order, so normalize explicitly to keep generated
    # XML byte-for-byte compatible with the legacy tool.
